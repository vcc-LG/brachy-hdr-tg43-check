...
def main():
    ...
    while True:
        input_str = input("Select case number: ")
        try:
    ...
    while True:
        input_str = input("Select plan number: ")
        try:
            if input_str.upper() == 'QUIT':
                sys.exit()
        except AttributeError:
    ...
    try:
        ...
        print(err)
        print("Could not open RTPlan file. Try a different plan.")
        sys.exit()
